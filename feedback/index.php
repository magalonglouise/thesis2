...
<div class="container">		
	...
	<div id="ratingDetails"> 		
		<div class="row">			
			...
			<div class="col-sm-3">
				<button type="button" id="rateProduct" class="btn btn-default">Rate us</button>
			</div>		
		</div>
		<div class="row">
			<div class="col-sm-7">
				...
				<?php
				$ratinguery = "SELECT ratingId, Id, userId, ratingNumber, title, comments, created, modified FROM feedback";
			...
			<div class="col-sm-12">
				<form id="ratingForm" method="POST">					
					...
					<div class="form-group">
						...
						<textarea class="form-control" rows="5" id="comment" name="comment" placeholder="Comment" required></textarea>
					</div>
					<div class="form-group">
