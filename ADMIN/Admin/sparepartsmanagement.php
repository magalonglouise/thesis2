                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <button type="submit" class="btn btn-sm " name="add_spareparts" style="background-color: #B80011;color: white"><i class="fa fa-motorcycle" aria-hidden="true"></i> Add </button>
